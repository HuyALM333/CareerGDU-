        ...
        const fetchJob = async () => {
            try {
                ...
                if (data.success && data.data) {
                    ...
                    const resolvedCustomField = resolvedField === "Khác" && job.field !== "Khác" ? job.field : ""

                    setCustomField(resolvedCustomField)
                    ...
                    form.reset({
                        ...
                        postedAt: (job as any).publishAt ? new Date((job as any).publishAt) : (job.postedAt ? new Date(job.postedAt) : new Date()),
                    })
